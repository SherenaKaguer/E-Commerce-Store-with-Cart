...
('admin', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin@shop.com', 'Administrator', 'admin'),
('john_doe', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'john@example.com', 'John Doe', 'user'),
('jane_smith', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'jane@example.com', 'Jane Smith', 'user');

-- Insert products
INSERT IGNORE INTO products (name, slug, description, short_description, price, compare_price, category_id, stock_quantity, sku, is_featured) VALUES
('Wireless Headphones', 'wireless-headphones', 'Premium noise-cancelling wireless headphones with 30-hour battery life. Perfect for travel and daily use.', 'Premium noise-cancelling wireless headphones', 99.99, 149.99, 1, 50, 'WH-001', TRUE),
('Smart Watch', 'smart-watch', 'Fitness tracker with heart rate monitor, GPS, and 7-day battery life. Track your health and stay connected.', 'Fitness tracker with heart rate monitor', 199.99, 249.99, 1, 30, 'SW-001', TRUE),
('Cotton T-Shirt', 'cotton-tshirt', 'Comfortable 100% cotton t-shirt available in multiple sizes. Breathable and perfect for everyday wear.', 'Comfortable 100% cotton t-shirt', 24.99, 39.99, 2, 100, 'CT-001', FALSE),
('Programming Book', 'programming-book', 'Learn PHP and MySQL from scratch. Build dynamic websites with practical examples and projects.', 'Learn PHP and MySQL from scratch', 45.99, 59.99, 3, 25, 'PB-001', FALSE),
('Coffee Mug', 'coffee-mug', 'Ceramic coffee mug with lid. Microwave and dishwasher safe. Holds 15oz of your favorite beverage.', 'Ceramic coffee mug with lid', 12.99, 19.99, 4, 75, 'CM-001', FALSE);
